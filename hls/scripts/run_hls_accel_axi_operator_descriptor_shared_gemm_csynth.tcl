...
#   vitis_hls -f path/to/run_hls_accel_axi_operator_descriptor_shared_gemm_csynth.tcl
#
# Small-shape synthesis sanity for the multi-word operator descriptor AXI top.
# The project name keeps the same shared_gemm prefix as this Tcl for quick lookup.
