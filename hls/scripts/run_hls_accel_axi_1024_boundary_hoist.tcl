...
# This variant keeps generic runtime N/K/M support, but hoists A/B/C boundary
# handling out of compute_block's local feeding path. load_ab_block still pads
# invalid A/B elements to zero and store_c_block still checks C writeback bounds.
...
set project_name "accel_axi_o1_1024_boundary_hoist"
set cflags [format "-I%s -I%s -DGZY_GEMM_TILE=14 -DGZY_GEMM_BLOCK_M=14 -DGZY_ACCEL_BLOCK_N=112 -DGZY_ACCEL_BLOCK_K=112 -DGZY_ACCEL_BLOCK_M=112 -DGZY_ACCEL_LOAD_AB_PARALLEL=1 -DGZY_ACCEL_LOCAL_ROW_UNROLL=1 -DGZY_ACCEL_LOCAL_AB_PARALLEL=0 -DGZY_ACCEL_LOCAL_DOUBLE_BUFFER=0 -DGZY_ACCEL_DATAFLOW_BLOCK_OVERLAP=0 -DGZY_ACCEL_COMPUTE_PADDED_INPUTS=1 -DGZY_ACCEL_FULL_BLOCK_FAST=0 -DGZY_ACCEL_FULL_ONLY=0 -DGZY_ACCEL_MAX_N=1024 -DGZY_ACCEL_MAX_K=1024 -DGZY_ACCEL_MAX_M=1024 -DGZY_ACCEL_BENCH_N=112 -DGZY_ACCEL_BENCH_K=112 -DGZY_ACCEL_BENCH_M=112 -DGZY_ACCEL_MAX_INSTR=4" \
    $src_dir $tb_dir]
