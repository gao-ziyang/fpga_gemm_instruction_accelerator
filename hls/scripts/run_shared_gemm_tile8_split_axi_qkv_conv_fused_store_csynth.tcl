...
#   vitis_hls -f path/to/run_shared_gemm_tile8_split_axi_qkv_conv_fused_store_csynth.tcl
#
# Stage-3a probe: split AXI, QKV fused GEMM store, and Conv2D fused
# channel-major GEMM store. Conv im2col/weight flatten are still explicit
# descriptor helpers in this probe.
