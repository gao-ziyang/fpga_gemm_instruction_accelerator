# Canonical all-accelerator baseline.
# Stage5 = TILE8 shared GEMM hardware with Conv2D/QKV/attention descriptor
# support, prepacked Conv weight path, pow2 attention normalization, serial
# im2col, and stride=1 Conv descriptor assumption.
