...
#   vitis_hls -f path/to/run_hls_attention_score_scheduler_csynth.tcl
#
# Narrow synthesis target for the layer_gemm scheduler backend.
# This measures only attention_score_top, i.e. Score = Q * K^T, plus the
# transpose and pack/unpack bridge currently inside layer_gemm.
...
open_project -reset attention_score_layer_scheduler_csynth
...
add_files -cflags $cflags [file join $src_dir "attention_top.cpp"]
