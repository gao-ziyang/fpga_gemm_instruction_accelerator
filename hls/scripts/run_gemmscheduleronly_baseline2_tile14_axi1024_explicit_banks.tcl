# Canonical GEMM-only board-facing baseline.
# This is the validated TILE14 / BLOCK112 / MAX1024 AXI top with boundary
# hoist + explicit PL-local banks. It is the version used for 1008/1024 board
# validation, so it is the practical GEMM baseline2.
...
set project_name "gemmscheduleronly_baseline2_tile14_axi1024_explicit_banks"
