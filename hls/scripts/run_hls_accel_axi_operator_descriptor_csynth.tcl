...
#   vitis_hls -f path/to/run_hls_accel_axi_operator_descriptor_csynth.tcl
#
# Small-shape synthesis sanity for the multi-word operator descriptor AXI top.
# This checks that the descriptor implementation is synthesizable before a
# larger board-facing IP package script is prepared.
...
open_project -reset accel_axi_operator_descriptor_csynth
