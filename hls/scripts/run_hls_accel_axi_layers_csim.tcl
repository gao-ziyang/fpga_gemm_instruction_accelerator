...
#   vitis_hls -f path/to/run_hls_accel_axi_layers_csim.tcl
#
# Functional C simulation for the AXI top using the extended layer instruction
# stream: QKV, attention-score, and conv-as-GEMM.
...
open_project -reset accel_axi_layers_csim
...
add_files -tb -cflags $cflags [file join $tb_dir "tb_accelerator_top_axi_layers.cpp"]
