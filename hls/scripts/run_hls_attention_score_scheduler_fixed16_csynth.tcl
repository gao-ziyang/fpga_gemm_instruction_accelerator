...
#   vitis_hls -f path/to/run_hls_attention_score_scheduler_fixed16_csynth.tcl
#
# Fixed-shape attention-score benchmark top for C-synth latency reporting.
# Shape is Score = Q[16,96] * K_T[96,16].
...
open_project -reset attention_score_layer_scheduler_fixed16_csynth
set_top attention_score_scheduler_bench_top
...
add_files -cflags $cflags [file join $src_dir "attention_score_scheduler_bench_top.cpp"]
