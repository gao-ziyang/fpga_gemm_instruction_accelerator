...
#   vitis_hls -f path/to/run_hls_accel_axi_operator_descriptor_shared_gemm_tile12_csynth.tcl
#
# TILE=12 resource probe for the shared-gemm operator descriptor AXI top.
...
set project_name "accel_axi_operator_descriptor_shared_gemm_tile12_csynth"
set cflags [format "-I%s -I%s -DGZY_GEMM_TILE=12 -DGZY_GEMM_BLOCK_M=12 -DGZY_ACCEL_BLOCK_N=24 -DGZY_ACCEL_BLOCK_K=48 -DGZY_ACCEL_BLOCK_M=48 -DGZY_ACCEL_MAX_N=64 -DGZY_ACCEL_MAX_K=128 -DGZY_ACCEL_MAX_M=1024 -DGZY_ACCEL_MAX_INSTR=32 -DGZY_ACCEL_BENCH_N=16 -DGZY_ACCEL_BENCH_K=96 -DGZY_ACCEL_BENCH_M=96 -DGZY_ACCEL_SHARED_GEMM_INLINE=1" $src_dir $tb_dir]
