...
#   vitis_hls -f path/to/run_shared_gemm_tile10_split_axi_csynth.tcl
#
# Stage-1 split-AXI-bundle probe for the shared-gemm operator descriptor AXI top.
...
set project_name "shared_gemm_tile10_split_axi_csynth"
set cflags [format "-I%s -I%s -DGZY_GEMM_TILE=10 -DGZY_GEMM_BLOCK_M=10 -DGZY_ACCEL_BLOCK_N=20 -DGZY_ACCEL_BLOCK_K=40 -DGZY_ACCEL_BLOCK_M=40 -DGZY_ACCEL_MAX_N=64 -DGZY_ACCEL_MAX_K=128 -DGZY_ACCEL_MAX_M=1024 -DGZY_ACCEL_MAX_INSTR=32 -DGZY_ACCEL_BENCH_N=16 -DGZY_ACCEL_BENCH_K=96 -DGZY_ACCEL_BENCH_M=96 -DGZY_ACCEL_SHARED_GEMM_INLINE=1 -DGZY_ACCEL_SPLIT_AXI_BUNDLES=1" $src_dir $tb_dir]
