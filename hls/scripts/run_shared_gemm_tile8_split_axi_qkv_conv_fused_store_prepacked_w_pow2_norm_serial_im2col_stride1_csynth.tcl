...
#   vitis_hls -f path/to/run_shared_gemm_tile8_split_axi_qkv_conv_fused_store_prepacked_w_pow2_norm_serial_im2col_stride1_csynth.tcl
#
# Stage-5 probe: Stage-4b plus a stride=1 Conv2D descriptor assumption. This
# removes runtime out_h/out_w division from execute_instruction_stream for the
# current conv workload shape.
