...
#   vitis_hls -f path/to/run_shared_gemm_tile8_split_axi_qkv_conv_fused_store_direct_w_csynth.tcl
#
# Stage-3b probe: Stage-3a plus direct Conv2D weight load in gemm_scheduler.
# This removes conv2d_flatten_weight_to_b from the fused path.
