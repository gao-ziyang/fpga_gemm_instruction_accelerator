...
#   vitis_hls -f path/to/run_attention_hls.tcl
#
# Stage 4: synthesize attention_top, which validates
# QKV -> QK^T -> row-normalization -> P * V.
...
open_project -reset attention_hls
