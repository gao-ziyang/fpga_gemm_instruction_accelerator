...
#   vitis_hls -f path/to/run_shared_gemm_tile12_csynth.tcl
#
# Stage-0 resource/timing sweep for the shared-gemm operator descriptor AXI top.
...
set project_name "shared_gemm_tile12_csynth"
