# Focused log11 O3 run: TILE=14, BLOCK=112, combined external A/B load,
# combined local A/B load, no row-direction extra banking.
...
set project_name "accel_log11_o3_tile14_localab_128"
